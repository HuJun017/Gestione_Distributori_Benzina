...
# Cambio prezzo carburante per provincia
...
if st.button("Aggiorna prezzi"):
    data = requests.post(
        f"{API_URL}/distributori/prezzo/{prov}",
        params={"tipo": tipo, "nuovo_prezzo": nuovo_prezzo}
    ).json()
    st.json(data)
